...
git clone https://Gypsyan:${GITHUB_TOKEN}@github.com/Gypsyans/KGRadioButton.git
cd KGRadioButton
git remote rm origin
git remote add origin https://Gypsyan:${GITHUB_TOKEN}@github.com/Gypsyans/KGRadioButton.git
